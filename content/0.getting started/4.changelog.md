...
<div style="background: #e6f4ff; border-radius: 8px; padding: 1.2em 1.5em; margin-bottom: 1.5em; border: 1px solid #b6e0fe; color: #1a237e;">
  <strong style="font-size: 1.1em; color: #1976d2;">Looking for Msty Studio and Desktop 2.0?</strong><br>
  <span style="color: #1a237e;">Check out the <a href="https://msty.ai/changelog?utm_source=msty_app&utm_campaign=docs" target="_blank" style="color: #1565c0; text-decoration: underline; font-weight: bold;">Msty Studio Changelog</a>.</span>
</div>
